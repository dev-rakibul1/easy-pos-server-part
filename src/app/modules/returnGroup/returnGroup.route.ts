...
router.get(
  ...
  ReturnGroupController.SingleReturnGroupByCurrentDateController,
)
router.get(
  '/get-by-current-week',
  AuthProvider.Auth(
  ...
  ReturnGroupController.SingleReturnGroupByCurrentWeekController,
)
router.get(
  ...
  ReturnGroupController.SingleReturnGroupByCurrentMonthController,
)
router.get(
  '/get-by-current-year',
  AuthProvider.Auth(
